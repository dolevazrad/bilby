...
import bilby
import numpy as np
from HelperFunction import calculate_m1_m2_from_chirp_mass_and_ratio,calculate_chirp_mass_and_ratio
...
# Make a corner plot.
result.plot_corner()
result.posterior['mass_1'], result.posterior['mass_2'] = calculate_m1_m2_from_chirp_mass_and_ratio(result.posterior['chirp_mass'], result.posterior['mass_ratio'])
parameter_order = [
    'psi', 'a_2', 'a_1', 'tilt_2', 'tilt_1', 'phi_12', 'phi_jl', 'luminosity_distance', 'theta_jn',
    'phase', 'ra', 'mass_ratio', 'chirp_mass', 'dec'
]
